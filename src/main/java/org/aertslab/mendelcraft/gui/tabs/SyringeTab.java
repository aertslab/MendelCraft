...
import org.aertslab.mendelcraft.gui.buttons.ChromosomeButton;
import org.aertslab.mendelcraft.gui.buttons.GeneButton;
				...
				getScreen().addRenderableWidget(
						new ChromosomeButton(relX + 20 + 25 * (i % 4), relY + 20, (b) -> setChrome(relX, relY, atom),
								(b, p, x, y) -> getScreen().renderTooltip(p,
										new TranslatableComponent("mendelcraft.chromosome." + atom.get()), x, y),
