 ...
 */
public class GuiDnaMain extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (currentPage instanceof GuiContainerPage) {
            this.drawContainerScreen(mouseX, mouseY, partialTicks);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (currentPage instanceof GuiContainerPage) {
            this.mouseContainerClicked(mouseX, mouseY, mouseButton);
        } else {
    ...
    protected void mouseReleased(int mouseX, int mouseY, int state) {
        ...
        if (this.currentPage instanceof GuiContainerPage) {
            this.mouseContainerReleased(mouseX, mouseY, state);
        } else {
     ...
     */
    public void drawContainerScreen(int mouseX, int mouseY, float partialTicks) {
     ...
     */
    protected void mouseContainerClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        super.mouseClicked(mouseX, mouseY, mouseButton);
     ...
     * Called when a mouse button is released.
     */
    protected void mouseContainerReleased(int mouseX, int mouseY, int state) {
